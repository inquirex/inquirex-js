...
export class IqMultiEnum extends LitElement {
  static styles = css`
    ...
    .option:hover {
      border-color: color-mix(in srgb, var(--iq-highlight, var(--iq-brand, #2563eb)) 50%, var(--iq-border, #d4d4d8));
      background: color-mix(in srgb, var(--iq-highlight, var(--iq-brand, #2563eb)) 4%, var(--iq-surface, #fff));
    }
    .option:active { transform: scale(0.98); }
    .option[data-selected] {
      border-color: var(--iq-highlight, var(--iq-brand, #2563eb));
      background: color-mix(in srgb, var(--iq-highlight, var(--iq-brand, #2563eb)) 8%, var(--iq-surface, #fff));
    }
    .checkbox {
    ...
    .option[data-selected] .checkbox {
      border-color: var(--iq-highlight, var(--iq-brand, #2563eb));
      background: var(--iq-highlight, var(--iq-brand, #2563eb));
    }
    .check-icon {
      opacity: 0;
